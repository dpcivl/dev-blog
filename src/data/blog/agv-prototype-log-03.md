...
### 5. 부품 통합 쇼핑 채널이 한국에 부족한 문제

프로젝트를 하다 보니까 짜잘짜잘한 부품들을 살 일이 많은데:

- **쿠팡**에서 사려고 하면 판매자마다 배송비를 내야 함
- **디바이스마트**에서 사면 시간도 걸리고, 그렇게까지 살 일이 없는데 많이 담아야 할 거 같은 느낌

미국·유럽엔 **Mouser, Digi-Key, LCSC** 같은 통합 채널이 있는데 한국에선 디바이스마트 / IC114 / 엘레파츠 정도가 그나마 가깝다. 다음에 한 번 채널별 라인업 정리해보자 (BOM 작성 시 효율 차이 클 듯).

> 자료 / 추천 받습니다. 이런 데서 부품 구하기 좋다 — 댓글이나 [@dpcivl](https://x.com/dpcivl) 로 알려주세요.
