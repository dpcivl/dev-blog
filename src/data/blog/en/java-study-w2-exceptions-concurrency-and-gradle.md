---
title: "Java Study W2 (Continued) — Exception Handling · Concurrency · record · Modern Java · Gradle"
...
Continuing from [W2 Collections · Stream part](/en/posts/java-study-w2-collections-and-streams), wrapping up W2. Today's goal is to roughly finish sweeping through Java syntax — **exception handling · concurrency · record · Modern Java · Gradle**.
...
![ThreadDemo execution — sequential 3008ms vs concurrent (pool-1-thread-1/2/3) 1006ms](/assets/posts/java-study-w2-exceptions-concurrency-and-gradle/01-thread-demo-output.png)
...
![gradle-demo project structure — app/build.gradle, gradle/wrapper, gradle.properties, gradlew, settings.gradle](/assets/posts/java-study-w2-exceptions-concurrency-and-gradle/02-gradle-project-structure.png)
...
Three things that clicked while wrapping up W2:
