---
title: "출시 하루 전, 성능을 뜯어고쳤다 — 그리고 못 고친 것 하나"
description: "1인 개발 중인 앱을 출시하기 하루 전, TTFB 3.15초 → 10ms · LCP 22.1초 → 1.4초 로 뜯어고친 튜닝 회고. 그리고 하루를 태우고도 결국 웹으로는 못 고친 PWA 하단 시스템 바 색 이야기."
...
출시를 앞두고 하루를 통째로 성능에 갈아넣었다. 잘 된 것도 있지만, 이 글에서 진짜 남기고 싶은 건 **하루를 태우고도 결국 웹으로는 못 고친 그 하나** 다.
