...
![ThreadDemo 실행 — 순차 3008ms vs 동시 (pool-1-thread-1/2/3) 1006ms](/assets/posts/java-study-log-03-exceptions-concurrency-and-gradle/01-thread-demo-output.png)
...
![gradle-demo 프로젝트 구조 — app/build.gradle, gradle/wrapper, gradle.properties, gradlew, settings.gradle](/assets/posts/java-study-log-03-exceptions-concurrency-and-gradle/02-gradle-project-structure.png)
