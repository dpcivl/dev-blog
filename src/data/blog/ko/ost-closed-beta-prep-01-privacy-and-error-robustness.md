---
title: "OST 클로즈베타 준비 #1 — 에러 견고성 · 개인정보 고지 초안 · 동의 게이트"
...
![OST 동의 게이트 — (필수) 개인정보 수집·이용, (필수) 민감정보(정서·마음 기록) 처리, (선택) 개인정보 국외이전 3개 항목 체크 UI](/assets/posts/ost-closed-beta-prep-01-privacy-and-error-robustness/01-consent-gate.png)
